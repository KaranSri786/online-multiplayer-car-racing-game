class Game {
  ...
  displayRank(){
    ...
    Player.getPlayerInfo();
    imageMode(CENTER);
    image(bronze_img,displayWidth/-4,displayHeight/9-100,100,100);
    image(silver_img,displayWidth/4,displayHeight/10-100,100,100);
    image(gold_img,0,-90,100,100);
    textSize(50);
    textAlign(CENTER);
    fill("gold");
    for(var plr in allPlayers){
       if(allPlayers[plr].rank===1){
        ...
        text("LOST IT : " + allPlayers[plr].name,0,220);
